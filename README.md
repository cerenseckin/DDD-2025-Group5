...
### Data Organisation
 ...
 - Have you used any AI-based tool to understand and manipulate your data? if yes, what and how?</li>


### General inspirational questions

#### Alien traces in human evolution history:
- archeological sites without (yet) human explanation
- weird super all drawings representing the same figures all around the world
- Nazca lines
